...
[![CI](https://github.com/zAlweNy26/capacitor-plugins/actions/workflows/ci.yml/badge.svg)](https://github.com/zAlweNy26/capacitor-plugins/actions/workflows/ci.yml)
...
This is a [Bun](https://bun.sh) workspace monorepo. See each package's `CONTRIBUTING.md` for setup, build, and release instructions.
